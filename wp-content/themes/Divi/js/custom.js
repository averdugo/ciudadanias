(function($){
	...
	$('body').on('click','.btn12',function(e){
		e.preventDefault();
		$('.hide1').fadeToggle();
	})
	$('body').on('click','.btn13',function(e){
		e.preventDefault();
		$('.hide2').fadeToggle();
	})

	$('body').on('click','.btn14',function(e){
		e.preventDefault();
		$('.hide3').fadeToggle();
	})
	$('body').on('click','.btn15',function(e){
		e.preventDefault();
		$('.hide4').fadeToggle();
	})
	$('body').on('click','.btn16',function(e){
		e.preventDefault();
		$('.hide5').fadeToggle();
	})
