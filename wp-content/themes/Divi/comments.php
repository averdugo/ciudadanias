...
<?php endif; ?>
	...
	<?php endif; ?>
	<?php if ('open' == $post->comment_status) : ?>
		<?php comment_form( array('label_submit' => esc_attr__( 'Enviar Comentario', 'Divi' ), 'title_reply' => '<span>' . esc_attr__( 'Enviar un Comentario', 'Divi' ) . '</span>', 'title_reply_to' => esc_attr__( 'Deja un mensaje para %s', 'Divi' ), 'class_submit' => 'submit et_pb_button' ) ); ?>
	<?php else: ?>
