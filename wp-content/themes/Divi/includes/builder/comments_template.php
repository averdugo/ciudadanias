...
<section id="comment-wrap">
	...
	<?php endif; ?>
	<?php if ('open' == $post->comment_status) : ?>
		<?php comment_form( array('label_submit' => esc_attr__( 'Enviar Comentario', 'et_builder' ), 'title_reply' => '<span>' . esc_attr__( 'Enviar un Comentario', 'et_builder' ) . '</span>', 'title_reply_to' => esc_attr__( 'Leave a Reply to %s', 'et_builder' ), 'class_submit' => 'submit et_pb_button' ) ); ?>
	<?php else: ?>
