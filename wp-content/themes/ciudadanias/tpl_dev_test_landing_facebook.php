<?php
/**
 * Template Name: Landing DEV TEST
 */
...
<html <?php language_attributes(); ?>>
	<head>
        ...
        window.fbAsyncInit = function(){
		        FB.init({appId: '178814522252757', status: true, cookie: true, xfbml: true, oauth: true});
	...
	<body <?php body_class(getBrowserClass()." landing landing-facebook"); ?>>
		<div id="fb-root"></div>
		<div id="main-wraper">
			<div id="header-top">
		...
		<div id="content-wraper">
			<div id="content">
				...
				<div class="rightCol">
					...
					<div class="small-box box-border custom-form-box">
						<?php
							if ( is_active_sidebar( 'contact-form-facebook' ) ){
								dynamic_sidebar( 'contact-form-facebook' );
							}
						?>
					</div>
